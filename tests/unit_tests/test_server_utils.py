...
class TestServerUtils:
    ...
    def test_initialize_ray_with_address(self, monkeypatch: MonkeyPatch) -> None:
        ...
        ray_init_mock.assert_called_once_with(address="ray://test-address:10001", ignore_reinit_error=True, runtime_env={'working_dir': PARENT_DIR})
    ...
    def test_initialize_ray_without_address(self, monkeypatch: MonkeyPatch) -> None:
        ...
        ray_init_mock.assert_called_once_with(ignore_reinit_error=True,runtime_env={'working_dir': PARENT_DIR})
