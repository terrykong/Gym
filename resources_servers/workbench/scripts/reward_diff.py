...
#             "arguments": "{\"customer_name\": \"Parker Miller\", \"assigned_to_email\": \"akira.sato@atlas.com\", \"status\": \"Lead\"}"
#         }
# ]
...
# {
#   "ground_truth": "[{\"name\": \"customer_relationship_manager_add_customer\", \"arguments\": \"{\\\"customer_name\\\": \\\"Parker Miller\\\", \\\"assigned_to_email\\\": \\\"akira.sato@atlas.com\\\", \\\"status\\\": \\\"Lead\\\"}\"}]",
#   "style": "rule"
# }
...
responses_create_params = NeMoGymResponseCreateParamsNonStreaming(
    ...
    input=[
        ...
        {"role": "user", "content": "Add Alex Wilson as a new lead in the crm and assign them to Sofia"},
    ],
    tools=[
        {
            "type": "function",
...
payload = SimpleAgentRunRequest(
    ...
    ground_truth=[
        {
            "name": "customer_relationship_manager_add_customer",
            "arguments": '{"customer_name": "Alex Wilson", "assigned_to_email": "sofia.santos@atlas.com", "status": "Lead"}',
        }
    ],
