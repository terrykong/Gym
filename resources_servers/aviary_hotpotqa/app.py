...
class AviaryHotpotqaResourcesServer(SimpleResourcesServer):
    ...
    def _create_session(self, env: HotPotQAEnv, env_config: dict) -> AviarySession:
        return AviarySession(env=env, env_config=env_config, turn_count=0)

    async def seed_session(
        self, request: Request, body: AviaryHotpotqaSeedSessionRequest
    ) -> AviaryHotpotqaSeedSessionResponse:
