...
The cookery part 1 is some text that varies. The cookery part 1 is " safe.[if c_1 is open and there is something in the c_1] The safe contains [a list of things in the c_1]. Classic TextWorld.[end if]".
The cookery part 2 is some text that varies. The cookery part 2 is "[if c_1 is open and the c_1 contains nothing] The safe is empty! This is the worst thing that could possibly happen, ever![end if]".
The cookery part 3 is some text that varies. The cookery part 3 is " What's that over there? It looks like it's a platter. The platter is normal.[if there is something on the s_0] On the platter you see [a list of things on the s_0].[end if]".
The cookery part 4 is some text that varies. The cookery part 4 is "[if there is nothing on the s_0] The platter appears to be empty.[end if]".
...
The parlor part 1 is some text that varies. The parlor part 1 is "[if c_0 is open and the c_0 contains nothing] The trunk is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The c_2 is in r_1.
The c_2 is locked.
The description of o_0 is "The hat appears to be out of place here".
...
Test quest0_0 with "go west / take strawberry from trunk / go east / go north / eat strawberry"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is how to play! First off, move west. Once you get through with that, take the strawberry from the".
The objective part 1 is some text that varies. The objective part 1 is " trunk. And then, eat the strawberry. That's it!".
