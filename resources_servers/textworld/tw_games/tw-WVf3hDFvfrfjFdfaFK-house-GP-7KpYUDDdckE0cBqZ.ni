...
The study part 1 is some text that varies. The study part 1 is " coffer in the corner.[if c_0 is open and there is something in the c_0] The coffer contains [a list of things in the c_0]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The study part 2 is some text that varies. The study part 2 is "[if c_0 is open and the c_0 contains nothing] The coffer is empty! What a waste of a day![end if]".
The study part 3 is some text that varies. The study part 3 is " You make out a desk. [if there is something on the s_0]On the desk you can see [a list of things on the s_0]. Hmmm... what else, what else?[end if]".
The study part 4 is some text that varies. The study part 4 is "[if there is nothing on the s_0]Looks like someone's already been here and taken everything off it, though. You move on, clearly angry about your TextWorld experience.[end if]".
The study part 5 is some text that varies. The study part 5 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The study part 6 is some text that varies. The study part 6 is " gate leading west. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You've entered an usual room. Your mind races to think of what kind of room would be usual. And then it hits you. Of course. You're in the kitchenette. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.



 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchenette part 1 is some text that varies. The kitchenette part 1 is " gate leading east. You need an unguarded exit? You should try going south.".
...
The description of o_0 is "The cloak appears out of place here".
...
Test quest0_0 with "unlock gate with passkey / open gate / go east / close gate"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Here is how to play! First of all, unlock the gate with the passkey. Then, make sure that the gate wi".
The objective part 1 is some text that varies. The objective part 1 is "thin the kitchenette is opened. And then, try to travel east. With that done, close the gate. Alright, thanks!".
